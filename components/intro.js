...
export default function Intro() {
  return (
    <section className="py-10 px-5 sm:px-10 flex flex-col justify-between items-center gap-10">
      ...
      <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-10">
        ...
        <div className="w-full h-full p-5 border-solid border rounded-md border-white/50 hover:border-white/70 transition-all duration-200 flex flex-col justify-between basis-1/2 gap-6">
          <div className="flex justify-between items-center	">
